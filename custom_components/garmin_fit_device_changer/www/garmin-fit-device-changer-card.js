...
class GarminFitDeviceChangerCard extends HTMLElement {
  constructor() {
    ...
    this._open = { profiles: true, reference: false, manual: false, patch: true };
  }
  ...
  _wire() {
    ...
    [["#details-profiles","profiles"],["#details-reference","reference"],["#details-manual","manual"],["#details-patch","patch"]].forEach(([selector,key]) => {
